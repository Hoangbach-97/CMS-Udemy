    ...
    <div class="container">
        ...
        if(isset($_GET['p_id']))
        {
            ...
            //    $comment_status= $_POST['comment_status'];
               ...
               if(!$create_query) die("Error ". mysqli_error($connection));
            }
            ...
            ?>
                ...
                <div class="well">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder=""rows="3" name="comment_author">
                    </div>

                    <div class="form-group">
                        <label for="comment_email">Email</label>
                            <input type="text" class="form-control" placeholder=""rows="3" name="comment_email">
                        </div>
                ...
                if(!$select_comment_query) die("Error ". mysqli_error($connection));
